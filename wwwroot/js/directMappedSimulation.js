var DirectMappedSimulation = {
    ...
    startSimulation: function () {
        ...
        DirectMappedSimulation.highlightCurrentInstruction();

        DirectMappedSimulation.memorySize = $("#memorySize").val();
        DirectMappedSimulation.cacheSize = $("#cacheSize").val();
        DirectMappedSimulation.dataSize = $("#dataSize").val();
        ...
        var simulationParameters = {
            ...
            'MemorySize': DirectMappedSimulation.memorySize,
            'CacheSize': DirectMappedSimulation.cacheSize,
            'DataSize': DirectMappedSimulation.dataSize,
    ...
    updateButtons: function () {
        ...
        DirectMappedSimulation.instructionCount--;

        if (DirectMappedSimulation.instructionCount == 0) {
    ...
    highlightCurrentInstruction: function () {
        var newDivContent = "";

        for (var line = 0; line < this.instructionLines.length; line++) {
            if (line == this.currentInstruction) {
